...
export interface ApiBibliographyBibliography
  extends Struct.CollectionTypeSchema {
...
export interface ApiMeetingMeeting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    materials: Schema.Attribute.Media<'images' | 'files', true>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    recording: Schema.Attribute.String;
    references: Schema.Attribute.Component<'link.references', true>;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tag.tag'> &
      Schema.Attribute.Private;
    meetings: Schema.Attribute.Relation<'manyToMany', 'api::meeting.meeting'>;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiZoomZoom extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    link: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.DefaultTo<'https://us02web.zoom.us/j/87056843362'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
